        ...
        headers: [
          ...
          { key: "Strict-Transport-Security", value: "max-age=31536000; includeSubDomains" },
          {
            ...
            value: [
              ...
              `connect-src 'self'${isDev ? " ws: http://localhost:* http://127.0.0.1:*" : ""} https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://firebaseinstallations.googleapis.com https://api.sandbox.midtrans.com https://api.midtrans.com https://nominatim.openstreetmap.org https://*.ingest.us.sentry.io ` + (process.env.NEXT_PUBLIC_API_URL ?? ""),

    ...
    <>
      ...
      <header className="topbar">
        <nav className="nav shell">
          ...
          <div className={`nav-links${isMenuOpen ? " open" : ""}`} id="nav-menu">
                  ...
                  {languages.map((lang) => (
                    <button
                      ...
                      style={{
                        ...
                        border: 0,
                        cursor: "pointer",
                        fontWeight: locale.toUpperCase() === lang.code ? 700 : 400,
                        color: locale.toUpperCase() === lang.code ? "var(--primary)" : "var(--text-soft)",
                      }}
                    >
      ...
      <main id="top">
        ...
        <section className="hero shell">
          <div className="hero-copy">
            <span className="eyebrow">Save Time &amp; Spend It With Loved Ones</span>
            <h1>
            ...
            <div className="hero-actions">
              <a className="button" href="/book/location">{t("landingPage.track.bookNow")}</a>
              <a className="button button-muted" href="#pricing">{t("landingPage.nav.pricing")}</a>
            </div>
          </div>
          ...
          <div className="tracker-card">
            ...
            <div className="bubble-progress" aria-label="Wash progress example">
              {trackStepsData.flatMap(({ done, current }, i) => {
                const bubbleCls = current ? "bubble bubble-active" : done ? "bubble bubble-done" : "bubble bubble-idle";
                ...
                if (i < trackStepsData.length - 1) {
                  ...
                  elements.push(
                    <div key={`line-${i}`} className={`bubble-line${lineActive ? " bubble-line-active" : ""}`} />
                  );
                }
                return elements;
              })}
      ...
      <footer className="footer">
        <div className="shell footer-inner">
          ...
          <div className="footer-links">
            ...
            <a href="/privacy-policy">{t("landingPage.footer.privacyPolicy")}</a>
      ...
      <nav className="mobile-dock">
        <a className="dock-link active" href="#top">Home</a>
        <a
          className="dock-link"
          href="#process"

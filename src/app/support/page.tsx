...
const faqs = [
  {
    ...
    answer:
      "Book a waterless car wash through our app by selecting your parking location and vehicle. Our crew will find your car, perform the wash, and notify you when it's done — all while you shop or work.",
  },
  {
    question: "Is waterless washing safe for my car?",
    answer:
      "Yes. Our waterless wash formula is specially designed to lubricate and lift dirt safely without scratching the paint. It is used by professional detailers worldwide and is safe for all car finishes.",
  },
  {
    question: "How long does the wash take?",
    answer:
      "A standard waterless car wash typically takes 20–40 minutes depending on your vehicle size and level of dirt. You can track the progress in real time through the app.",
  },
  {
    question: "What if I'm not satisfied with the result?",
    answer:
      "Contact us within 24 hours of service completion. Our team will review your case and arrange a re-wash or refund as appropriate.",
  },
  {
    question: "Can I cancel my booking?",
    answer:
      "Yes, you can cancel before a crew member is assigned and receive a full refund. Once service has started, cancellations are not available.",
  },
  {
    question: "Which parking locations are supported?",
    answer:
      "We currently operate at selected malls and commercial parking areas in Jakarta. Check the app for the full list of supported locations — we're expanding regularly.",
  },
  {
    question: "Do I need to be present during the wash?",
    answer:
      "No. Simply book, park your car, and go about your day. You'll receive a notification when the crew starts and when the wash is complete.",
  },
  {
    question: "How do I track my wash status?",
    answer:
      "After booking, you can view real-time status updates in the app — from crew assignment through each wash stage to completion.",
  },
];
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-[800px] mx-auto w-full px-4 md:px-12 py-12 md:py-16">
        ...
        {/* Still need help CTA */}
        <div
          className="bg-[#f0f4ff] border border-[#dce1ff] rounded-2xl p-8 text-center"
        >
          <h3
          ...
          <p
            ...
            style={{ fontFamily: inter, fontWeight: 400 }}
          >
            Our support team is available Monday–Saturday, 08:00–20:00 WIB.
          </p>

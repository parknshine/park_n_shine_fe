...
const CardLabel = ({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) => (
  <p
    className={cn(
...
export { Card, CardHeader, CardLabel, CardTitle, CardDescription, CardContent, CardFooter };

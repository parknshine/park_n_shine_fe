...
const EVENT_TYPES = ["booking_status_changed", "job_assigned", "new_job", "crew_time_extension_request", "eta_extended", "time_extension_approved", "time_extension_rejected"];

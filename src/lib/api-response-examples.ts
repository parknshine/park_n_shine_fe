  ...
  bookingFetched: createApiSuccessMessageResponse<CustomerBooking>({
    ...
    data: {
      ...
      statusHistory: [
        ...
        {
          status: "PENDING",
          changedAt: "2026-05-21T09:01:00.000Z",
          labelKey: "status.pending",
        },
        {
          status: "PAID",
          changedAt: "2026-05-21T09:03:00.000Z",
          labelKey: "status.paid",
        },
        {
          status: "ASSIGNED",
          changedAt: "2026-05-21T09:05:00.000Z",
  ...
  ratingSubmitted: createApiSuccessMessageResponse<CustomerBooking>({
    ...
    data: {
      ...
      statusHistory: [
        {
          status: "READY",
          changedAt: "2026-05-21T09:28:00.000Z",
          labelKey: "status.ready",
        },
        {
          status: "CLOSED",
          changedAt: "2026-05-21T09:35:00.000Z",
...
export const crewSuccessExamples = {
  ...
  nextJobClaimed: createApiSuccessMessageResponse<CrewJob>({
    ...
    data: {
      ...
      checklist: [
        {
          id: "step_rinse",
          labelKey: "checklist.rinse",
          order: 1,
          completedAt: null,
        },
        {
          id: "step_apply_waterless",
          labelKey: "checklist.applyWaterless",
          order: 2,
          completedAt: null,
        },
        {
          id: "step_wipe",
          labelKey: "checklist.wipe",
          order: 3,
          completedAt: null,
        },
        {
          id: "step_final_wipe",
          labelKey: "checklist.finalWipe",
          order: 4,
          completedAt: null,
        },
      ],
  ...
  beforePhotoUploaded: createApiSuccessMessageResponse<CrewJob>({
    ...
    data: {
      ...
      media: [
        {
          id: "media_before_front",
          kind: "front",
          url: "https://cdn.park-shine.com/media/before_front.jpg",
        },
        {
          id: "media_before_back",
          kind: "back",
          url: "https://cdn.park-shine.com/media/before_back.jpg",
        },
        {
          id: "media_before_left",
          kind: "left",
          url: "https://cdn.park-shine.com/media/before_left.jpg",
        },
        {
          id: "media_before_right",
          kind: "right",
          url: "https://cdn.park-shine.com/media/before_right.jpg",
        },
      ],
      checklist: [],
    },
      ...
      checklist: [
        {
          ...
          labelKey: "checklist.rinse",
          order: 1,
          completedAt: "2026-05-21T09:12:00.000Z",
        },
        {
          id: "step_apply_waterless",
          labelKey: "checklist.applyWaterless",
      ...
      media: [
        {
          id: "media_after",
          kind: "after",
          url: "https://cdn.park-shine.com/media/after.jpg",
        },
      ],
      checklist: [
        {
        ...
        },
        {
          ...
          labelKey: "checklist.applyWaterless",
          order: 2,
          completedAt: "2026-05-21T09:15:00.000Z",
        },
        {
          id: "step_wipe",
          labelKey: "checklist.wipe",
          order: 3,
          completedAt: "2026-05-21T09:20:00.000Z",
        },
        {
          id: "step_final_wipe",
          labelKey: "checklist.finalWipe",
          order: 4,
          completedAt: "2026-05-21T09:25:00.000Z",
        },
      ],
    },
    meta: META,
...
export const crewErrorExamples = {
  ...
  shiftCodeInvalid: createApiErrorMessageResponse({
    ...
    fieldErrors: [{ field: "shiftCode", message: "Shift code tidak valid." }],
    meta: META,
  }),
};
      ...
      auditEntries: [
        {
          ...
          action: "reassign",
          detail:
            "Dialihkan ke Agus Widodo. Alasan: Crew sebelumnya tidak hadir.",
      ...
      auditEntries: [
        {
          ...
          detail:
            "Status diubah dari PENDING ke PAID. Alasan: Bank konfirmasi lunas, webhook tidak masuk.",
          adminEmail: "supervisor@park-shine.com",

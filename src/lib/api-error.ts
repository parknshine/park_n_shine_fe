...
export const API_ERROR_CODES = {
  ...
  CREW_INVALID_CREDENTIALS: "CREW_INVALID_CREDENTIALS",
...
export const API_ERROR_DEFINITIONS: Record<ApiErrorCode, ApiErrorDefinition> = {
  ...
  BOOKING_TOKEN_EXPIRED: {
    defaultHttpStatus: 401,
    isRetryable: false,
    messageKey: "errors.customer.bookingTokenExpired",
    requirement: "FR-04",
    severity: "error",
    surface: "customer",
  },
  ...
  CREW_INVALID_CREDENTIALS: {
    defaultHttpStatus: 401,
    isRetryable: false,
    messageKey: "errors.crew.invalidCredentials",
    requirement: "FR-22",
    severity: "error",
    surface: "crew",
  },

...
type QrReason = "invalid" | "paused" | "past_cutoff";
...
export function QrErrorState({ reason }: QrErrorStateProps) {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center">
      ...
      <div className="space-y-1">
        ...
        <p className="max-w-xs text-sm text-muted-foreground">{t(REASON_KEY[reason])}</p>
      </div>
    </div>
  );
}
